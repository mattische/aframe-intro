...
- lägg nu till en scen, som vanligt. I o m att vi har lagt till ovan komponent så kan vi nu göra lite inställningar med attribut/properties som finns tillgängliga. Lägg till följande;
```html
<head>
  <title>env</title>
  <script src="https://aframe.io/releases/1.6.0/aframe.js"></script>
...
- experimentera med fler attribut och olika miljöer. Lägg till t ex dimma (fog), växla mellan miljöer etc.
